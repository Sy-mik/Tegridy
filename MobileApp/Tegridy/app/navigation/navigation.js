    ...
    <BottomTab.Navigator>
      <BottomTab.Screen
        ...
        options={{
          ...
          style={{padding:10}} size={24} name="time-slot" />,
        }}
      >
        {() => (
          <HomeStack.Navigator>
            <HomeStack.Screen name="Scheduled items" component={ScheduledList} />
      ...
      <BottomTab.Screen
        ...
        options={{
          title: "",
          tabBarIcon: ({ isActive }) => <Entypo style={{padding:10}} size={24} name="flower" />,
        }}
      >
        {() => (
          <HomeStack.Navigator>
